 ...
 *  网络请求子项
 */
@interface CWAsiNetworkItem : NSObject

/**
 *  网络请求方式
 */
@property (nonatomic, assign) RequestAsiNetWorkType networkType;
 ...
 *  网络请求的委托
 */
@property (nonatomic, assign) id<CWAsiNetworkDelegate>delegate;
/**
 *   target
 */
