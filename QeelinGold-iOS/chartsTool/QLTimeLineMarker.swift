...
class QLTimeLineMarker: MarkerImage {
...
//            print(clickPoint.x)
//            print((self.chartView?.bounds.size.width)! - rect.size.width / 2 - 37)
            if clickPoint.x < rect.size.width / 2 + 33 {
               clickPoint.x = rect.size.width / 2 + 33
            }else if clickPoint.x > (self.chartView?.bounds.size.width)! - rect.size.width / 2 - 37{
                clickPoint.x = (self.chartView?.bounds.size.width)! - rect.size.width / 2 - 37
            }
            context.setFillColor(color.cgColor)
            context.beginPath()
            context.move(to: CGPoint(
